...
>>>>>>> main
  ...
  %"0510.0" = select i1 %0, i64 1, i64 -1
  %"0538.0" = select i1 %1, i64 1, i64 -1
  %"0566.0" = select i1 %2, i64 1, i64 -1
  %"0594.0" = select i1 %3, i64 1, i64 -1
  %7 = add nsw i64 %"0538.0", %"0510.0"
  %8 = add nsw i64 %7, %"0566.0"
  %9 = add nsw i64 %8, %"0594.0"
  %10 = mul nsw i64 %9, %9
