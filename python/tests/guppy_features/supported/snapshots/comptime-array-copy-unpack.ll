...
@0 = private unnamed_addr constant [18 x i8] c"array_first___INT\00", align 1
@1 = private unnamed_addr constant [19 x i8] c"array_tail_1___INT\00", align 1
@2 = private unnamed_addr constant [20 x i8] c"array_mutated___INT\00", align 1
...
alloca_block:
  ...
  tail call void @__quantum__rt__int_record_output(i64 1, ptr nonnull @0)
  tail call void @__quantum__rt__int_record_output(i64 3, ptr nonnull @1)
  tail call void @__quantum__rt__int_record_output(i64 10, ptr nonnull @2)
  ret void
}
