...
@0 = private unnamed_addr constant [18 x i8] c"pcg_bounded___INT\00", align 1
@1 = private unnamed_addr constant [15 x i8] c"pcg_next___INT\00", align 1
...
alloca_block:
  ...
  tail call void @__quantum__rt__int_record_output(i64 1010964048, ptr nonnull @1)
  ret void
}
