...
@0 = private unnamed_addr constant [16 x i8] c"stack_len___INT\00", align 1
@1 = private unnamed_addr constant [16 x i8] c"stack_top___INT\00", align 1
@2 = private unnamed_addr constant [17 x i8] c"stack_next___INT\00", align 1
...
cond_exit_871:
  ...
  tail call void @__quantum__rt__int_record_output(i64 5, ptr nonnull @1)
  tail call void @__quantum__rt__int_record_output(i64 3, ptr nonnull @2)
  ret void
}
