...
@1 = private unnamed_addr constant [7 x i8] c"ints:0\00", align 1
@2 = private unnamed_addr constant [7 x i8] c"ints:1\00", align 1
@3 = private unnamed_addr constant [7 x i8] c"ints:2\00", align 1
@4 = private unnamed_addr constant [8 x i8] c"uints:0\00", align 1
@5 = private unnamed_addr constant [8 x i8] c"uints:1\00", align 1
@6 = private unnamed_addr constant [8 x i8] c"uints:2\00", align 1
...
__barray_check_none_borrowed.exit104:
  ...
  tail call void @__quantum__rt__int_record_output(i64 0, ptr nonnull @2)
  tail call void @__quantum__rt__int_record_output(i64 1, ptr nonnull @3)
  tail call void @__quantum__rt__int_record_output(i64 1, ptr nonnull @4)
  tail call void @__quantum__rt__int_record_output(i64 2, ptr nonnull @5)
  tail call void @__quantum__rt__int_record_output(i64 3, ptr nonnull @6)
  ret void
}
