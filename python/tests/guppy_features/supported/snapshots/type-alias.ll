...
@0 = private unnamed_addr constant [14 x i8] c"row_sum___INT\00", align 1
@1 = private unnamed_addr constant [17 x i8] c"pair_first___INT\00", align 1
...
alloca_block:
  ...
  tail call void @__quantum__rt__int_record_output(i64 10, ptr nonnull @0)
  tail call void @__quantum__rt__int_record_output(i64 8, ptr nonnull @1)
  ret void
}
