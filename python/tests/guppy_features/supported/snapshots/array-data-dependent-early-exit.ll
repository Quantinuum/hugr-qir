...
@0 = private unnamed_addr constant [14 x i8] c"target___BOOL\00", align 1
...
alloca_block:
  ...
  br i1 %0, label %cond_exit_85, label %cond_exit_113.1

cond_exit_85:                                     ; preds = %cond_exit_113.1, %alloca_block
...
cond_exit_113.1:                                  ; preds = %alloca_block
  tail call void @__quantum__qis__phasedx__body(double 0x400921FB54442D18, double 0.000000e+00, ptr nonnull inttoptr (i64 1 to ptr))
  tail call void @__quantum__qis__phasedx__body(double 0x400921FB54442D18, double 0.000000e+00, ptr nonnull inttoptr (i64 1 to ptr))
  tail call void @__quantum__qis__phasedx__body(double 0x400921FB54442D18, double 0.000000e+00, ptr nonnull inttoptr (i64 1 to ptr))
  br label %cond_exit_85
}
