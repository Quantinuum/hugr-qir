...
@0 = private unnamed_addr constant [2 x i8] c"q\00", align 1
@1 = private unnamed_addr constant [8 x i8] c"other_q\00", align 1
...
>>>>>>> main
  ...
  tail call void @__quantum__rt__bool_record_output(i1 %1, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @1, i64 0, i64 0))
  ret void
}
