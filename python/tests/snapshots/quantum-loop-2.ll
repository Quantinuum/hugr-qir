...
cond_394_case_0:                                  ; preds = %alloca_block, %21
...
2:                                                ; preds = %cond_394_case_0
  ...
  br label %cond_394_case_0.1

cond_394_case_0.1:                                ; preds = %2, %cond_394_case_0
...
4:                                                ; preds = %cond_394_case_0.1
  tail call void @__quantum__qis__phasedx__body(double 0x3FF921FB54442D18, double 0xBFF921FB54442D18, %Qubit* null)
  tail call void @__quantum__qis__rz__body(double 0x400921FB54442D18, %Qubit* null)
  br label %cond_394_case_0.2

cond_394_case_0.2:                                ; preds = %4, %cond_394_case_0.1
...
6:                                                ; preds = %cond_394_case_0.2
  tail call void @__quantum__qis__phasedx__body(double 0x3FF921FB54442D18, double 0xBFF921FB54442D18, %Qubit* null)
  tail call void @__quantum__qis__rz__body(double 0x400921FB54442D18, %Qubit* null)
  br label %cond_394_case_0.3

cond_394_case_0.3:                                ; preds = %6, %cond_394_case_0.2
...
8:                                                ; preds = %cond_394_case_0.3
  tail call void @__quantum__qis__phasedx__body(double 0x3FF921FB54442D18, double 0xBFF921FB54442D18, %Qubit* null)
  tail call void @__quantum__qis__rz__body(double 0x400921FB54442D18, %Qubit* null)
  br label %cond_394_case_0.4

cond_394_case_0.4:                                ; preds = %8, %cond_394_case_0.3
...
10:                                               ; preds = %cond_394_case_0.4
  tail call void @__quantum__qis__phasedx__body(double 0x3FF921FB54442D18, double 0xBFF921FB54442D18, %Qubit* null)
  tail call void @__quantum__qis__rz__body(double 0x400921FB54442D18, %Qubit* null)
  br label %cond_394_case_0.5

cond_394_case_0.5:                                ; preds = %10, %cond_394_case_0.4
...
12:                                               ; preds = %cond_394_case_0.5
  tail call void @__quantum__qis__phasedx__body(double 0x3FF921FB54442D18, double 0xBFF921FB54442D18, %Qubit* null)
  tail call void @__quantum__qis__rz__body(double 0x400921FB54442D18, %Qubit* null)
  br label %cond_394_case_0.6

cond_394_case_0.6:                                ; preds = %12, %cond_394_case_0.5
...
14:                                               ; preds = %cond_394_case_0.6
  tail call void @__quantum__qis__phasedx__body(double 0x3FF921FB54442D18, double 0xBFF921FB54442D18, %Qubit* null)
  tail call void @__quantum__qis__rz__body(double 0x400921FB54442D18, %Qubit* null)
  br label %cond_394_case_0.7

cond_394_case_0.7:                                ; preds = %14, %cond_394_case_0.6
...
16:                                               ; preds = %cond_394_case_0.7
  tail call void @__quantum__qis__phasedx__body(double 0x3FF921FB54442D18, double 0xBFF921FB54442D18, %Qubit* null)
  tail call void @__quantum__qis__rz__body(double 0x400921FB54442D18, %Qubit* null)
  br label %cond_394_case_0.8

cond_394_case_0.8:                                ; preds = %16, %cond_394_case_0.7
...
18:                                               ; preds = %cond_394_case_0.8
  tail call void @__quantum__qis__phasedx__body(double 0x3FF921FB54442D18, double 0xBFF921FB54442D18, %Qubit* null)
  tail call void @__quantum__qis__rz__body(double 0x400921FB54442D18, %Qubit* null)
  br label %cond_394_case_0.9

cond_394_case_0.9:                                ; preds = %18, %cond_394_case_0.8
  tail call void @__quantum__qis__mz__body(%Qubit* null, %Result* nonnull inttoptr (i64 10 to %Result*))
  %19 = tail call i1 @__quantum__qis__read_result__body(%Result* nonnull inttoptr (i64 10 to %Result*))
  ...
  %20 = tail call i1 @__quantum__qis__read_result__body(%Result* nonnull inttoptr (i64 11 to %Result*))
