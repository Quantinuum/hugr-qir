...
NodeBlock12897:                                   ; preds = %NodeBlock12899
  ...
  br i1 %Pivot12898, label %NodeBlock12897select.merge_dup, label %NodeBlock12897select.merge_dup12927

NodeBlock12897select.merge_dup:                   ; preds = %NodeBlock12897
  br i1 %brmerge, label %cond_8553_case_0.sink.split_dup, label %NodeBlock12908

cond_8553_case_0.sink.split_dup:                  ; preds = %NodeBlock12897select.merge_dup
  call void @__quantum__qis__rz__body(double 0x400921FB54442D18, %Qubit* inttoptr (i64 5 to %Qubit*))
  br label %NodeBlock12908

NodeBlock12897select.merge_dup12927:              ; preds = %NodeBlock12897
  br i1 %brmerge, label %cond_8553_case_0.sink.split_dup12932, label %NodeBlock12908

cond_8553_case_0.sink.split_dup12932:             ; preds = %NodeBlock12897select.merge_dup12927
...
LeafBlock12893:                                   ; preds = %NodeBlock12899
  br i1 %SwitchLeaf12894, label %cond_8553_case_0.sink.split_dup12933, label %NodeBlock12908

cond_8553_case_0.sink.split_dup12933:             ; preds = %LeafBlock12893
  call void @__quantum__qis__rz__body(double 0x400921FB54442D18, %Qubit* inttoptr (i64 4 to %Qubit*))
  br label %NodeBlock12908

NodeBlock12908:                                   ; preds = %LeafBlock12893, %cond_8553_case_0.sink.split_dup12933, %NodeBlock12897select.merge_dup12927, %cond_8553_case_0.sink.split_dup12932, %NodeBlock12897select.merge_dup, %cond_8553_case_0.sink.split_dup
...
NodeBlock12906:                                   ; preds = %NodeBlock12908
  ...
  br i1 %Pivot12907, label %NodeBlock12906select.merge_dup, label %NodeBlock12906select.merge_dup12928

NodeBlock12906select.merge_dup:                   ; preds = %NodeBlock12906
  br i1 %brmerge12917, label %cond_9059_case_0.sink.split_dup, label %cond_9059_case_0

cond_9059_case_0.sink.split_dup:                  ; preds = %NodeBlock12906select.merge_dup
  call void @__quantum__qis__rz__body(double 0x400921FB54442D18, %Qubit* inttoptr (i64 8 to %Qubit*))
  br label %cond_9059_case_0

NodeBlock12906select.merge_dup12928:              ; preds = %NodeBlock12906
  br i1 %brmerge12917, label %cond_9059_case_0.sink.split_dup12934, label %cond_9059_case_0

cond_9059_case_0.sink.split_dup12934:             ; preds = %NodeBlock12906select.merge_dup12928
...
LeafBlock12902:                                   ; preds = %NodeBlock12908
  br i1 %SwitchLeaf12896, label %cond_9059_case_0.sink.split_dup12935, label %cond_9059_case_0

cond_9059_case_0.sink.split_dup12935:             ; preds = %LeafBlock12902
  call void @__quantum__qis__rz__body(double 0x400921FB54442D18, %Qubit* inttoptr (i64 7 to %Qubit*))
  br label %cond_9059_case_0

cond_9059_case_0:                                 ; preds = %LeafBlock12902, %cond_9059_case_0.sink.split_dup12935, %NodeBlock12906select.merge_dup12928, %cond_9059_case_0.sink.split_dup12934, %NodeBlock12906select.merge_dup, %cond_9059_case_0.sink.split_dup
...
NodeBlock12915:                                   ; preds = %cond_9059_case_0
  ...
  br i1 %Pivot12916, label %NodeBlock12915select.merge_dup, label %NodeBlock12915select.merge_dup12930

NodeBlock12915select.merge_dup:                   ; preds = %NodeBlock12915
  br i1 %brmerge12920, label %cond_9887_case_0.sink.split_dup, label %cond_9887_case_0

cond_9887_case_0.sink.split_dup:                  ; preds = %NodeBlock12915select.merge_dup
  call void @__quantum__qis__rz__body(double 0x400921FB54442D18, %Qubit* inttoptr (i64 11 to %Qubit*))
  br label %cond_9887_case_0

NodeBlock12915select.merge_dup12930:              ; preds = %NodeBlock12915
  br i1 %brmerge12920, label %cond_9887_case_0.sink.split_dup12936, label %cond_9887_case_0

cond_9887_case_0.sink.split_dup12936:             ; preds = %NodeBlock12915select.merge_dup12930
...
NodeBlock12915.thread:                            ; preds = %cond_9059_case_0
  ...
  br i1 %brmerge12919, label %cond_9887_case_0, label %cond_9887_case_0.sink.split_dup12937

cond_9887_case_0.sink.split_dup12937:             ; preds = %NodeBlock12915.thread
  call void @__quantum__qis__rz__body(double 0x400921FB54442D18, %Qubit* inttoptr (i64 13 to %Qubit*))
  br label %cond_9887_case_0

cond_9887_case_0:                                 ; preds = %NodeBlock12915.thread, %cond_9887_case_0.sink.split_dup12937, %NodeBlock12915select.merge_dup12930, %cond_9887_case_0.sink.split_dup12936, %NodeBlock12915select.merge_dup, %cond_9887_case_0.sink.split_dup
