...
alloca_block:
  ...
  tail call void @__quantum__qis__phasedx__body(double 0x3FF921FB54442D18, double 0xBFF921FB54442D18, ptr nonnull inttoptr (i64 1 to ptr))
  tail call void @__quantum__qis__rz__body(double 0x400921FB54442D18, ptr nonnull inttoptr (i64 1 to ptr))
  br i1 %0, label %bb, label %cond_164_case_1

cond_164_case_1:                                  ; preds = %alloca_block, %bb
  tail call void @__quantum__qis__mz__body(ptr null, ptr null)
  %1 = tail call i1 @__quantum__rt__read_result(ptr null)
  ...
  %2 = tail call i1 @__quantum__rt__read_result(ptr nonnull inttoptr (i64 1 to ptr))
  tail call void @__quantum__rt__bool_record_output(i1 %2, ptr nonnull @1)
  ret void

bb:                                               ; preds = %alloca_block
  tail call void @__quantum__qis__phasedx__body(double 0x3FF921FB54442D18, double 0xBFF921FB54442D18, ptr nonnull inttoptr (i64 1 to ptr))
  tail call void @__quantum__qis__rz__body(double 0x400921FB54442D18, ptr nonnull inttoptr (i64 1 to ptr))
  br label %cond_164_case_1
}
