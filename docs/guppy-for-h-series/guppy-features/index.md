...
Where possible, each page pairs a supported example with one or more nearby counterexamples that currently fail during QIR conversion. For unsupported cases, the expected error output is documented.
