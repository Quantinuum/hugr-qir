...
alloca_block:
  ...
  tail call void @__quantum__rt__bool_record_output(i1 %4, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @4, i64 0, i64 0))
  ...
  tail call void @__quantum__rt__bool_record_output(i1 %5, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @5, i64 0, i64 0))
  ret void
}
