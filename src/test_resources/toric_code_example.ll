...
alloca_block:
  ...
  %5 = or i64 %4, %"2776_0.0"
  %6 = or i64 %5, %"2811_0.0"
  tail call void @__quantum__rt__int_record_output(i64 %6, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @0, i64 0, i64 0))
  tail call void @__quantum__qis__phasedx__body(double 0x3FF921FB54442D18, double 0xBFF921FB54442D18, %Qubit* nonnull inttoptr (i64 3 to %Qubit*))
  tail call void @__quantum__qis__rz__body(double 0x400921FB54442D18, %Qubit* nonnull inttoptr (i64 3 to %Qubit*))
  tail call void @__quantum__qis__phasedx__body(double 0x3FF921FB54442D18, double 0xBFF921FB54442D18, %Qubit* nonnull inttoptr (i64 2 to %Qubit*))
  tail call void @__quantum__qis__rz__body(double 0x400921FB54442D18, %Qubit* nonnull inttoptr (i64 2 to %Qubit*))
...
cond_exit_4993:                                   ; preds = %10, %cond_exit_4625
  ...
  tail call void @__quantum__rt__int_record_output(i64 %17, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @1, i64 0, i64 0))
...
NodeBlock12878:                                   ; preds = %cond_exit_4993
  ...
  br i1 %Pivot12879, label %LeafBlock, label %NodeBlock

NodeBlock:                                        ; preds = %NodeBlock12878
  br label %NodeBlock12924

NodeBlock12924:                                   ; preds = %NodeBlock
...
LeafBlock12922:                                   ; preds = %NodeBlock12924
  ...
  br i1 %SwitchLeaf12923, label %cond_7219_case_0.fold.split, label %NewDefault
...
NewDefault:                                       ; preds = %LeafBlock12922
  br label %cond_7219_case_0.fold.split12873

cond_7219_case_0.fold.split12873:                 ; preds = %NewDefault, %LeafBlock, %LeafBlock12880, %LeafBlock12884
  br label %cond_7219_case_0

cond_7219_case_0.fold.split:                      ; preds = %LeafBlock12922
  br label %cond_7219_case_0

cond_7219_case_0:                                 ; preds = %NodeBlock12924, %cond_7219_case_0.fold.split, %NodeBlock12886, %LeafBlock, %NodeBlock12882, %LeafBlock12880, %LeafBlock12884, %cond_7219_case_0.fold.split12873
  %21 = phi i1 [ false, %LeafBlock12884 ], [ false, %cond_7219_case_0.fold.split12873 ], [ false, %LeafBlock12880 ], [ false, %NodeBlock12882 ], [ false, %NodeBlock12924 ], [ false, %LeafBlock ], [ true, %NodeBlock12886 ], [ false, %cond_7219_case_0.fold.split ]
  %22 = phi i1 [ false, %LeafBlock12884 ], [ false, %cond_7219_case_0.fold.split12873 ], [ false, %LeafBlock12880 ], [ true, %NodeBlock12882 ], [ false, %NodeBlock12924 ], [ false, %LeafBlock ], [ false, %NodeBlock12886 ], [ false, %cond_7219_case_0.fold.split ]
  %Pivot12909 = phi i1 [ false, %LeafBlock12884 ], [ true, %cond_7219_case_0.fold.split12873 ], [ false, %LeafBlock12880 ], [ false, %NodeBlock12882 ], [ false, %NodeBlock12924 ], [ true, %LeafBlock ], [ true, %NodeBlock12886 ], [ false, %cond_7219_case_0.fold.split ]
  %Pivot12907 = phi i1 [ false, %LeafBlock12884 ], [ true, %cond_7219_case_0.fold.split12873 ], [ true, %LeafBlock12880 ], [ false, %NodeBlock12882 ], [ false, %NodeBlock12924 ], [ true, %LeafBlock ], [ true, %NodeBlock12886 ], [ false, %cond_7219_case_0.fold.split ]
  %SwitchLeaf12905 = phi i1 [ false, %LeafBlock12884 ], [ false, %cond_7219_case_0.fold.split12873 ], [ false, %LeafBlock12880 ], [ false, %NodeBlock12882 ], [ true, %NodeBlock12924 ], [ false, %LeafBlock ], [ false, %NodeBlock12886 ], [ false, %cond_7219_case_0.fold.split ]
  %Pivot12916 = phi i1 [ true, %LeafBlock12884 ], [ true, %cond_7219_case_0.fold.split12873 ], [ true, %LeafBlock12880 ], [ false, %NodeBlock12882 ], [ true, %NodeBlock12924 ], [ true, %LeafBlock ], [ true, %NodeBlock12886 ], [ false, %cond_7219_case_0.fold.split ]
  %23 = phi i1 [ false, %LeafBlock12884 ], [ false, %cond_7219_case_0.fold.split12873 ], [ false, %LeafBlock12880 ], [ false, %NodeBlock12882 ], [ false, %NodeBlock12924 ], [ false, %LeafBlock ], [ false, %NodeBlock12886 ], [ true, %cond_7219_case_0.fold.split ]
  %24 = phi i1 [ false, %LeafBlock12884 ], [ false, %cond_7219_case_0.fold.split12873 ], [ false, %LeafBlock12880 ], [ true, %NodeBlock12882 ], [ false, %NodeBlock12924 ], [ false, %LeafBlock ], [ true, %NodeBlock12886 ], [ false, %cond_7219_case_0.fold.split ]
  %25 = phi i1 [ true, %LeafBlock12884 ], [ false, %cond_7219_case_0.fold.split12873 ], [ false, %LeafBlock12880 ], [ false, %NodeBlock12882 ], [ false, %NodeBlock12924 ], [ false, %LeafBlock ], [ false, %NodeBlock12886 ], [ false, %cond_7219_case_0.fold.split ]
  %Pivot12900 = phi i1 [ false, %LeafBlock12884 ], [ true, %cond_7219_case_0.fold.split12873 ], [ true, %LeafBlock12880 ], [ true, %NodeBlock12882 ], [ false, %NodeBlock12924 ], [ false, %LeafBlock ], [ true, %NodeBlock12886 ], [ true, %cond_7219_case_0.fold.split ]
  %Pivot12898 = phi i1 [ false, %LeafBlock12884 ], [ true, %cond_7219_case_0.fold.split12873 ], [ true, %LeafBlock12880 ], [ true, %NodeBlock12882 ], [ true, %NodeBlock12924 ], [ false, %LeafBlock ], [ true, %NodeBlock12886 ], [ true, %cond_7219_case_0.fold.split ]
  %SwitchLeaf12896 = phi i1 [ false, %LeafBlock12884 ], [ false, %cond_7219_case_0.fold.split12873 ], [ false, %LeafBlock12880 ], [ false, %NodeBlock12882 ], [ false, %NodeBlock12924 ], [ true, %LeafBlock ], [ false, %NodeBlock12886 ], [ false, %cond_7219_case_0.fold.split ]
  %SwitchLeaf12894 = phi i1 [ false, %LeafBlock12884 ], [ false, %cond_7219_case_0.fold.split12873 ], [ true, %LeafBlock12880 ], [ false, %NodeBlock12882 ], [ false, %NodeBlock12924 ], [ false, %LeafBlock ], [ false, %NodeBlock12886 ], [ false, %cond_7219_case_0.fold.split ]
  tail call void @__quantum__qis__phasedx__body(double 0x3FF921FB54442D18, double 0xBFF921FB54442D18, %Qubit* nonnull inttoptr (i64 12 to %Qubit*))
  tail call void @__quantum__qis__rz__body(double 0x400921FB54442D18, %Qubit* nonnull inttoptr (i64 12 to %Qubit*))
  tail call void @__quantum__qis__phasedx__body(double 0x3FF921FB54442D18, double 0xBFF921FB54442D18, %Qubit* nonnull inttoptr (i64 15 to %Qubit*))
  tail call void @__quantum__qis__rz__body(double 0x400921FB54442D18, %Qubit* nonnull inttoptr (i64 15 to %Qubit*))
...
NodeBlock12897:                                   ; preds = %NodeBlock12899
  ...
  %.mux = select i1 %Pivot12898, %Qubit* inttoptr (i64 5 to %Qubit*), %Qubit* inttoptr (i64 6 to %Qubit*)
  br i1 %brmerge, label %cond_8553_case_0.sink.split, label %NodeBlock12908

LeafBlock12893:                                   ; preds = %NodeBlock12899
  br i1 %SwitchLeaf12894, label %cond_8553_case_0.sink.split, label %NodeBlock12908

cond_8553_case_0.sink.split:                      ; preds = %NodeBlock12897, %LeafBlock12893
  %.sink = phi %Qubit* [ inttoptr (i64 4 to %Qubit*), %LeafBlock12893 ], [ %.mux, %NodeBlock12897 ]
  tail call void @__quantum__qis__rz__body(double 0x400921FB54442D18, %Qubit* nonnull %.sink)
  br label %NodeBlock12908

NodeBlock12908:                                   ; preds = %NodeBlock12897, %cond_8553_case_0.sink.split, %LeafBlock12893
...
NodeBlock12906:                                   ; preds = %NodeBlock12908
  ...
  %.mux12918 = select i1 %Pivot12907, %Qubit* inttoptr (i64 8 to %Qubit*), %Qubit* inttoptr (i64 9 to %Qubit*)
  br i1 %brmerge12917, label %cond_9059_case_0.sink.split, label %cond_9059_case_0

LeafBlock12902:                                   ; preds = %NodeBlock12908
  br i1 %SwitchLeaf12896, label %cond_9059_case_0.sink.split, label %cond_9059_case_0

cond_9059_case_0.sink.split:                      ; preds = %NodeBlock12906, %LeafBlock12902
  %.sink12874 = phi %Qubit* [ inttoptr (i64 7 to %Qubit*), %LeafBlock12902 ], [ %.mux12918, %NodeBlock12906 ]
  tail call void @__quantum__qis__rz__body(double 0x400921FB54442D18, %Qubit* nonnull %.sink12874)
  br label %cond_9059_case_0

cond_9059_case_0:                                 ; preds = %NodeBlock12906, %LeafBlock12902, %cond_9059_case_0.sink.split
...
NodeBlock12915:                                   ; preds = %cond_9059_case_0
  ...
  %.mux12921 = select i1 %Pivot12916, %Qubit* inttoptr (i64 11 to %Qubit*), %Qubit* inttoptr (i64 13 to %Qubit*)
  br i1 %brmerge12920, label %cond_9887_case_0.sink.split, label %cond_9887_case_0

NodeBlock12915.thread:                            ; preds = %cond_9059_case_0
  %.not = xor i1 %23, true
  %brmerge12919 = or i1 %Pivot12916, %.not
  br i1 %brmerge12919, label %cond_9887_case_0, label %cond_9887_case_0.sink.split

cond_9887_case_0.sink.split:                      ; preds = %NodeBlock12915, %NodeBlock12915.thread
  %.sink12875 = phi %Qubit* [ %.mux12921, %NodeBlock12915 ], [ inttoptr (i64 13 to %Qubit*), %NodeBlock12915.thread ]
  tail call void @__quantum__qis__rz__body(double 0x400921FB54442D18, %Qubit* nonnull %.sink12875)
  br label %cond_9887_case_0

cond_9887_case_0:                                 ; preds = %NodeBlock12915, %NodeBlock12915.thread, %cond_9887_case_0.sink.split
...
cond_10152_case_1:                                ; preds = %cond_10117_case_0, %62
  ...
  tail call void @__quantum__rt__int_record_output(i64 %61, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @2, i64 0, i64 0))
  ret void
